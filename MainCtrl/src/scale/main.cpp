...
boolean scaleCalibrate(){
    ...
    LoadCell.setCalFactor(23);
    float newCalibrationValue = LoadCell.getCalFactor(); // get the new calibration value    Serial.print("New calibration value has been set to: ");
